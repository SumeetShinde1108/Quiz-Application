    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leaderboard', to='quiz_app.quiz')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['quiz'], name='quiz_app_le_quiz_id_d27d2c_idx'),
        ),
        migrations.AddIndex(
            model_name='leaderboard',
            index=models.Index(fields=['rank'], name='quiz_app_le_rank_9133aa_idx'),
        ),
